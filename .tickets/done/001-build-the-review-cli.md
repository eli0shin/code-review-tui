...
- [Research Herdr tabs and cabs for tool switching](../done/004-research-herdr-tabs-and-cabs-for-tool-switching.md) — Herdr provides persistent tabs, command execution, and focus through its installed CLI, but no cab or general return-to-caller abstraction.
...
- [Choose the Herdr focus compatibility boundary](../done/014-choose-the-herdr-focus-compatibility-boundary.md) — Append one best-effort Herdr CLI focus command after the launched command without race-free guarantees.
- [Define external process execution](../done/012-define-external-process-execution.md) — Use explicit Herdr CLI calls to create and focus Herdr tabs, run Lumen and Review Commands, and return to the Review Queue Tab.
...
- [Validate the first Review release](../done/023-validate-first-review-release.md).

## Resolution

The complete CLI was published as [v0.2.0](https://github.com/eli0shin/code-review-tui/releases/tag/v0.2.0) with four native binaries.
