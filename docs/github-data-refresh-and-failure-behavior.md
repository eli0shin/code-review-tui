...
Load details after a pull request becomes selected. A selection change cancels or makes obsolete the prior detail request; a late result must not replace the details for the current selection.
